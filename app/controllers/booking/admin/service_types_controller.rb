  ...
  class Admin::ServiceTypesController < ApplicationController
    ...
    def create
      ...
      if @service_type.save
        redirect_to [:admin, @category, @service_type], notice: 'Service type was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      ...
      if @service_type.update(service_type_params)
        redirect_to [:admin, @category, @service_type], notice: 'Service type was successfully updated.'
      else
        render :edit
      end
    end
